            ...
            <div className='flex flex-col items-center w-full min-h-full'>
                ...
                <div className='flex flex-col items-center justify-center w-full'>
                    <ul className='w-full flex flex-col gap-4'>
                        ...
                        <li onClick={() => router.push("/")} className={cn('flex items-center cursor-pointer justify-center text-lg font-poppins font-light w-full py-4 text-white px-4', (pathname === '/ar/' || pathname === '/') ? 'bg-gradient-to-r from-[#E72377] from-[-5.87%] to-[#EB5E1B] to-[101.65%]' : 'hover:bg-[#1d1926] ')}>
                            <p>Events</p>
                        </li>
