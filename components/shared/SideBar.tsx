...
export default function SideBar({ params, user }: Readonly<{ params: { locale?: string; }, user: UserType }>) {
    ...
    return (
        <>
            <aside className='hidden lg:block w-[320px] h-screen bg-[#452A7C1A] shadow-lg min-h-screen overflow-auto'>
